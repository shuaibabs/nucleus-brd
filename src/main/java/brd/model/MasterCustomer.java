...
public class MasterCustomer {
    ...
    public MasterCustomer(int customer_id, String customer_code, String customer_name, String customer_address_1, String customer_address_2, int customer_pincode, String email_address, int contact_number, String primary_contact_person, String record_status, String active_inactive_flag, Date create_date, String created_by, Date modified_date, String modified_by) {
